...
class ServiceController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $assets = ['datatable'];
        return view('service.index', compact('pageTitle','auth_user','assets','filter','postrequestid'));
    }
    ...
    public function create(Request $request)
    {
        ...
        // $servicedata->visit_type = json_decode($servicedata->visit_type, true);
        if(isset($servicedata))
        {
            $servicedata->visit_type_testing = $servicedata->visit_type;
        }
        // $servicedata['visit_type_testing'] = $servicedata['visit_type'];
    ...
    public function store(ServiceRequest $request)
    {
        ...
        $visit_type_stings = implode(",",$services['visit_type']);
        $services['visit_type'] = $visit_type_stings;
