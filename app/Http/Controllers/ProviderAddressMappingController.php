...
class ProviderAddressMappingController extends Controller
{
    ...
    public function index_data(DataTables $datatable,Request $request)
    {
        ...
        $query = ProviderAddressMapping::query()->myAddress()->where('provider_id',$providerdata);
    ...
    public function store(Request $request)
    {
        ...
        return redirect(route('provideraddress.show',$result->provider_id))->withSuccess($message);

        return redirect(route('provideraddress.show',['provideraddress' => $result->provider_id, 'id' => $result->provider_id]))->withSuccess($message);
