...
class BankController extends Controller
{
    ...
    public function banklist(Request $request, $id){
        ...
        return view('bank.list', compact('pageTitle' ,'providerdata' ,'auth_user','assets','filter' ));
    }

    public function index_data(DataTables $datatable,Request $request)
    {
        $providerdata = $request->providerbank;
        $query = Bank::query()->myBank()->where('provider_id',$providerdata);
    ...
    public function create(Request $request)
    {
        $id = $request->id;
        $auth_user = authSession();
        $providerbank = $request->providerbank;
        $providerdata = User::with('providerbank')->where('user_type','provider')->where('id',$providerbank)->first();
        ...
        return view('bank.create', compact('pageTitle', 'bankdata', 'auth_user','providerdata'));
    }
