...
use App\Http\Controllers\HandymanSlotController;
...
Route::group(['middleware' => ['auth', 'verified']], function()
{
    ...
    // ali
    Route::resource('timeslot', HandymanSlotController::class);
    Route::post('handyman-save-slot', [HandymanSlotController::class, 'store'] )->name('handymanslot.store');
    ...
    Route::get('handyman/request/{handyman_id}/{provider_id}/{status}',[HandymanController::class, 'request'])->name('handyman.request');
    ...
    Route::group(['middleware' => ['permission:booking list']], function () {
        ...
        Route::get('booking-calendar-view',[BookingController::class,'calendar'])->name('booking.calendar');
    ...
    Route::get('handyman-provider-list',[SettingController::class,'handyman_provider_list'])->name('handyman.provider_list');

    Route::get('provider_requests',[SettingController::class,'provider_requests'])->name('provider_requests_page');
