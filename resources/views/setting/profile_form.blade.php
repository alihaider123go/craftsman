        ...
        <div class="col-md-9">
            <div class="user-content">
                ...
                <div class="row ">
                    ...
                    @if(auth()->user()->hasRole('handyman'))
                        <div class="form-group col-md-12">
                            {{ Form::label('bio',__('messages.bio'), ['class' => 'form-control-label']) }}
                            {{ Form::textarea('bio', null, ['class'=>"form-control textarea" , 'rows'=>2  , 'placeholder'=> __('messages.bio_placeholder') ]) }}
                        </div>
                    @endif
