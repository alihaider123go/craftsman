                                ...
                                <ul class="nav flex-column nav-pills nav-fill tabslink" id="tabs-text" role="tablist">
                                    @if(in_array( $page,['profile_form','password_form','time_slot']))
                                        ...
                                        @role('handyman')
                                            ...
                                            <!-- <li class="nav-item">
                                                <a href="javascript:void(0)" data-href="{{ route('layout_page') }}?page=provider_requests" data-target=".paste_here" class="nav-link {{$page=='provider_requests'?'active':''}}"  data-toggle="tabajax" rel="tooltip"> {{ __('messages.provider_requests') }} </a>
                                            </li> -->
                                        @endrole
                                    @else
