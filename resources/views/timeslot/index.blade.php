                ...
                <div class="card card-block card-stretch">
                    <div class="card-body p-0">
                        <div class="d-flex justify-content-between align-items-center p-3">
                            <h5 class="font-weight-bold">{{ __('messages.update') }} {{$pageTitle}}</h5>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="card">
        <div class="card-body">
            <div class="row ">
                <div class="col-md-12">
                    <div class="">
                        {{ Form::model($slotsArray, ['method' => 'POST', 'route' => 'handymanslot.store', 'data-toggle' => 'validator', 'id' => 'handyman-form']) }}
                        <div class="row">
                            <div class="col-md-12">
                                <input type="hidden" name="id" id="handyman-id" value="{{ $handyman_id }}">
