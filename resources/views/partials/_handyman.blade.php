...
<div class="mb-3 ms-2">
    <ul class="nav nav--tabs nav--tabs__style2 provider-detail-tab">
        ...
        <li class="nav-item {{request()->routeIs('timeslot.show') ? 'active' : ''}}">
            <a class="nav-link" href="{{ route('timeslot.show',$handymandata->id) }}">{{__('messages.list_form_title',['form' => __('messages.slot')])}}</a>
        </li>
