...
@php
   ...
   $handyman_rating = App\Models\HandymanRating::where('handyman_id', $handymanData['data']['id'])->orderBy('created_at', 'desc')->get();
                     ...
                     <div class="table-responsive mt-5">
                        <table class="table table-borderless text-start mb-0">
                           <tbody>
                              ...
                              <tr>
                                 <td class="px-0">
                                    <h6 class="text-white m-0 lh-base">{{__('landingpage.projects')}}:</h6>
                                 </td>
                                 <td class="text-end pe-0">
                                    @php
                                        $completed_services = App\Models\BookingHandymanMapping::whereHas('bookings', function($query){
                              ...
                              <tr>
                                 ...
                                 <td class="text-end pe-0">
                                    @php
                                    $satisfy_customers = $handyman_rating
