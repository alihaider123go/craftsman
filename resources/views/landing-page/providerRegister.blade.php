    ...
    <div class="container-fluid px-lg-0 py-lg-0 pb-5">
        <div class="row min-vh-100 g-lg-0">
            ...
            {{--
                ...
                --}}
                <img src="{{ asset('images/frontend/landing-page/register-page.webp')}}" class="img-responsive w-100 h-100" alt="log-in"/>
            </div>
                    ...
                    <form method="POST" action="{{ route('register') }}" data-toggle="validator">
                        ...
                        <div class="row login_form">
                            ...
                            <div class="col-12 col-xl-6 col-lg-6 ">
                              ...
                              <div class="col-12 col-xl-6 col-lg-6 ">
                                <div class="form-group icon-right mb-5 custom-form-field d-flex flex-column">
