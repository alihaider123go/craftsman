...
<nav id="navbar_main" class="mobile-offcanvas nav navbar navbar-expand-xl hover-nav horizontal-nav py-xl-0">
    <div class="container-fluid p-lg-0">
        ...
        @php
                ...
                $serviceconfig = json_decode($settings['service-configurations']->value);
        ...
        <ul class="navbar-nav iq-nav-menu list-unstyled" id="header-menu">
            ...
            <li class="nav-item">
                <a class="nav-link {{ request()->routeIs('blog.*') ? 'active' : '' }}" target="_blank" href="#">{{__('landingpage.blogs')}}</a>
            ...
            @endif
            <!-- @if(auth()->check() && auth()->user()->user_type == 'user' && $serviceconfig->post_services == 1)
            <li class="nav-item">
