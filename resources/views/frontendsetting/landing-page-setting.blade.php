<div class="row">
    <div class="col-lg-12">
        <ul class="nav nav-tabs pay-tabs nav-fill tabslink" id="tab-text" role="tablist">
            ...
            <li class="nav-item payment-link">
                <a href="javascript:void(0)" data-href="{{ route('landing_layout_page') }}?tabpage=section_10" data-target=".payment_paste_here" data-toggle="tabajax"  class="nav-link  {{$tabpage=='section_10'?'active':''}}"   rel="tooltip"> {{__('messages.featured_providers')}}</a>
            </li>
