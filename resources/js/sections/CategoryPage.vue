...
useDataTable({
  ...
  url: props.link,
  custom_grid: 'row row-cols-xl-5 row-cols-lg-5 row-cols-md-4 row-cols-sm-2',
  dom: '<"row align-items-center"><"table-responsive" rt><"row align-items-center" <"col-md-6" l><"col-md-12 mt-md-0 mt-3" p>><"clear">',
  advanceFilter: () => {
    return {
        search: search.value,
    }
