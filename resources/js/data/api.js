...
export const GET_HANDYMAN_TIME_SLOT = (queryPerams) => {return `${BASE_URL}/get-handyman-slot?${generateQueryParams(queryPerams)}`}
...
export const FEATURED_PROVIDER_API = (queryPerams) => {return `${BASE_URL}/featured-provider-list?${generateQueryParams(queryPerams)}`}

export const PROVIDERS_COUNT_API = (queryPerams) => {return `${BASE_URL}/providers-count?${generateQueryParams(queryPerams)}`}
