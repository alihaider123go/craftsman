...
<div class="" v-if="section1Setting">
  <!-- <div class=""> -->
    ...
    <p class="iq-title-desc line-count-3 text-body mt-3 mb-0 banner-paragraph">
      {{ section1Setting.key === 'section_1' ? getJsonValue(section1Setting.value, 'description') : '' }}
                    ...
                    <button class="banner-pink-button ">Recherchez un service</button>
                    <button class="banner-transparent-button">Recherchez un prestataire</button>
                    </div> 
  <!-- </div> -->
</div>
